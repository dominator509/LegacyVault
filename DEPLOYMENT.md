...
Production is never automatic. After staging evidence, policy/vendor/legal/insurance evidence, digest signatures, restore results, and schema compatibility have been reviewed, an operator records the verified combined-image digest as `RELEASE_IMAGE_DIGEST` and runs exactly:
