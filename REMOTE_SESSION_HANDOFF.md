...
- Stripe delivered webhooks/payment lifecycle, Turnstile, Resend, hosted PostgreSQL/Redis/R2, GHCR, Fly, DNS/WAF and managed restore behavior have not been authenticated from this workspace, even where provisioning is operator-asserted.
