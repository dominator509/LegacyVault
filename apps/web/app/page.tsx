    ...
    <main>
      <section aria-labelledby="page-title">
        ...
        <p>
          ...
          compartmentalized continuity packets. External AI remains off until
      ...
      <section id="safety" aria-labelledby="safety-title">
        ...
        <p>
          Suggested facts are never confirmed automatically. Legacy Vault does
          not store passwords, recovery codes, private keys, full card numbers,
