...
alter table memberships add column auth_user_id text references "user" ("id") on delete cascade;
create unique index memberships_auth_user_household_unique on memberships (organization_id, household_id, auth_user_id) where auth_user_id is not null;
